...
/**
 * Entity for dealer support requests.
 * Stored in a dedicated table separate from end-user requests.
 */
@Entity
@Table(name = "dealer_support_requests")
public class DealerSupportRequest {
